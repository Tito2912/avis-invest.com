...
export const metadata: Metadata = {
  ...
  description: 'Guides, comparatifs et avis sur eToro, Bitpanda et l\'investissement : tout pour débuter sereinement et choisir la plateforme adaptée à vos objectifs.',
